  ...
  return (
    <div className={cn("fixed top-5 left-0 right-0 z-[9999]", className)}>
      <div className="flex justify-center pt-6">
        <motion.div
          className="flex items-center gap-3 bg-background/50 border border-border/30 backdrop-blur-lg py-2 px-2 rounded-full shadow-lg relative"
                  ...
                  >
                    <div className="relative w-12 h-12">
                      ...
                      >
                        ...
                        />
                        <motion.div
                          className="absolute w-2 h-1.5 bg-primary/60 rounded-full"
                          animate={{
