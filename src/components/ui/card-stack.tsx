    ...
    <div className="relative h-full w-full">
      ...
      {item.tag && (
        <div className="absolute top-3 left-3 z-10">
          <span className="px-2.5 py-1 rounded-full text-xs font-mono font-medium bg-primary/20 text-primary-foreground border border-primary/30 backdrop-blur-sm">
            {item.tag}
          </span>
        </div>
      )}
      <div className="relative z-10 flex h-full flex-col justify-end p-5">
        <div className="truncate text-lg font-semibold text-foreground font-mono">
          {item.title}
        </div>
        {item.description && (
