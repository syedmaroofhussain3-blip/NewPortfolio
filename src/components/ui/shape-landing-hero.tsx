...
function HeroGeometric({
    badge = "Portfolio",
    title1 = "Syed Maroof Hussain",
    title2 = "1st-Year B.Tech CCAI Student",
}: {
    badge?: string;
    title1?: string;
    title2?: string;
                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                            Building a strong foundation in Java and exploring
                            Cloud Infrastructure to craft scalable, modern solutions.
                        </p>
                    </motion.div>
                </div>
            </div>
