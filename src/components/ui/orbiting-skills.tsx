  ...
  return (
    ...
    >
      ...
      >
        ...
        {isHovered && (
          <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 px-2 py-1 bg-background/95 backdrop-blur-sm rounded text-xs text-foreground whitespace-nowrap pointer-events-none">
            {label}
          </div>
        )}
      </div>
...
export default function OrbitingSkills() {
  ...
  return (
    <div className="w-full flex items-center justify-center overflow-hidden">
      <div
        className="relative w-[calc(100vw-40px)] h-[calc(100vw-40px)] max-w-[450px] max-h-[450px] flex items-center justify-center"
